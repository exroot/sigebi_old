                ...
                <form method="POST" action="{{ '/admin/roles/' . $rol->id }}">
                    {{ csrf_field() }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="rol" type="text" class="form-control @error('rol') is-invalid @enderror" name="rol" value="{{ $rol->rol }}" required autofocus>
                        ...
                        <div class="form-group row mb-0 col-md-12 d-flex justify-content-center">
                            <a class="btn btn-outline-secondary col-md-2 mr-1" style="max-width: 35%" href="{{ '/admin/roles/' . $rol->id }}">
                                Cancelar
                            </a>
