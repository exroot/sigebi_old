                ...
                <form method="POST" action="{{ '/admin/carreras/' . $carrera->id }}">
                    {{ csrf_field() }}
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="carrera" type="text" class="form-control @error('carrera') is-invalid @enderror" name="carrera" value="{{ $carrera->carrera }}" required autofocus>
                        ...
                        <div class="form-group row mb-0 col-md-12 d-flex justify-content-center">
                            <a class="btn btn-outline-secondary col-md-2 mr-1" style="max-width: 35%" href="{{ '/admin/carreras/' . $carrera->id }}">
                                Cancelar
                            </a>
